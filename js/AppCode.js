define("my_example_appcode/AppCode", ["amber_vm/smalltalk", "amber_vm/nil", "amber_vm/_st", "amber_core/Canvas"], function(smalltalk,nil,_st){
smalltalk.addPackage('AppCode');
smalltalk.packages["AppCode"].transport = {"type":"amd","amdNamespace":"my_example_appcode"};
...
return _st($Browser())._openOn_(aClass);
...
self._renderBrowserButtonForClass_on_(self._class(),html);
